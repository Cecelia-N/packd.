<script lang="ts">
  ...
  import {type form} from '$lib/helpers/packer'
	import { coldClothesList } from '$lib/helpers/packer-new';
	import { getListIndex, getLists } from '$lib/stores/firestore';
...
<form >
  ...
  <div id="row5" class="row">
      ...
      <div id="row7" class="row final">
              ...
              <button type="button" class="btn-cta" on:click={submitForm}>Get your packing list now!</button>
